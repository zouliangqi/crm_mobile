...
class OaRecord2List extends StatelessWidget {
    ...
    void _onRefresh() async{
      await Future.delayed(
          Duration(milliseconds: 1000),
              ()=>BlocProvider.of<OaRecord2Bloc>(context).add(OaRecord2ListEvent(pageIndex: 1))
      );
      _refreshController.refreshCompleted();
    }
    return BlocBuilder<OaRecord2Bloc, OaRecord2State>(builder: (context, state) {
      //print(state.toString());
      if (state is OaRecord2ListSuccessState) {
                ...
                itemBuilder: (context, i) {
                  if(i==state.success.length){
                    if (state.hasReachedMax == false){
                        ...
                        BlocProvider.of<OaRecord2Bloc>(context).add(OaRecord2ListEvent());
...
//                                70+containerGrowAnimation.value *10,
      ...
      else if(state is OaRecord2ListFailState){
        return Center(
